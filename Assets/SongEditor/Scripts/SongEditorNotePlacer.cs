...
namespace RhythmEngine.Examples
{
    ...
    /// </summary>
    public class SongEditorNotePlacer : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (Input.GetKeyDown(KeyCode.Mouse1)) // Right mouse
            {
                ...
                SongEditor.ToggleNote(new Vector2Int(currentLane, currentBeat));
            }
        }
        ...
        private int GetBeatFromWorldPos(Vector3 worldPos)
        {
            ...
            var closestBeat = Mathf.Round(yPos / SongEditor.BeatSpacing) * SongEditor.BeatSpacing;
