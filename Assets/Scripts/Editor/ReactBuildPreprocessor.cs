...
public class ReactBuildPreprocessor : IPreprocessBuildWithReport
{
    ...
    private static string FindNpmExecutable()
    {
        ...
        {
            psi.EnvironmentVariables["PATH"] = "/usr/local/bin:/opt/homebrew/bin:" + psi.EnvironmentVariables["PATH"];
        }

        ReactBuildLogWindow.AddLine("PATH: " + psi.EnvironmentVariables["PATH"]);
    ...
    public static void RunNpmBuild(string path)
    {
        ...
        ReactBuildLogWindow.AddLine("Finished!");
    }
}