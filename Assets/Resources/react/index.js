...
function GameOver(){var globals=useGlobals();var gameLifecycleManager=globals.gameLifecycleManager;var status=useReactiveValue(globals.status);var canContinue=useReactiveValue(globals.canContinue);var title=status;if(canContinue){title="Let's keep dreaming~";}return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"gameover",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"title",children:title}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"content",children:[!canContinue&&/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Main Menu",onClick:function onClick(){gameLifecycleManager.ReturnToMainMenu();}}),canContinue&&/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Continue",onClick:function onClick(){gameLifecycleManager.ToNextLevel();}}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"score flex-row padding-md",children:/*#__PURE__*/(0,jsx_runtime.jsx)(src_score,{value:globals.score.Value})})]})]});}
