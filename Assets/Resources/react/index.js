...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".padding-md{padding:12px}.padding-lg{padding:24px}.spacer{flex-grow:1}.flex-column{display:flex;flex-direction:column}.flex-row{display:flex;flex-direction:row}.align-center{align-items:center}.justify-center{justify-content:center}.button{border:none;margin:0;padding:0;background:rgba(0,0,0,0);font-size:32px;color:#fff}.button:active{background-color:aqua;transform:scale(1.1)}.button:hover{transform:scale(1.1)}.score{color:#fff;font-size:24px}.score.text{padding-right:20px}.debug-ui{display:flex;flex-direction:column;padding:6px;position:absolute;width:100%;height:100%;background-color:rgba(0,0,0,0)}.debug-ui .footer{display:flex;flex-direction:row}.debug-ui .text{color:#fff;font-size:12px}.debug-ui .button{font-size:16px;border-radius:12px;border-width:1px;border-style:solid;border-color:#fff;width:100px}.main-menu{display:flex;flex-direction:column;justify-content:center;align-items:center;height:100%}.main-menu .content{display:flex;flex-direction:column;align-items:center;gap:24px}.main-menu .title{margin-top:-128px;margin-bottom:128px;text-align:center;color:#fff;font-size:64px}.pause-menu{height:100%}.pause-menu .container{padding-left:24px;padding-right:24px;color:#fff;gap:24px}.pause-menu .container .button{font-size:32px}.pause-menu .black-bar{display:flex;flex-direction:column;position:fixed;top:0;left:0;right:0;height:60px;background:linear-gradient(90deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.8) 20%, rgba(0, 0, 0, 0.8) 80%, rgba(0, 0, 0, 0.5))}.pause-menu .gradient-rule{height:1px;width:100%;background-image:linear-gradient(90deg, transparent, rgba(255, 255, 255, 0.8), transparent)}.gameover{display:flex;flex-direction:column;justify-content:center;align-items:center;height:100%}.gameover .title{margin-top:-128px;margin-bottom:128px;text-align:center;color:#fff;font-size:32px}.leaderboard .title{margin-top:128px;margin-bottom:128px;color:#fff;font-size:64px;text-align:center}.leaderboard .content{display:flex;flex-direction:column;margin:auto;gap:20px}.leaderboard .score{display:flex;flex-direction:row;justify-content:space-between;gap:100px}.leaderboard .button{font-size:32px;padding:128px}", ""]);
// Exports
...
function MainMenu(){var globals=useGlobals();var gameLifecycleManager=globals.gameLifecycleManager;return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"main-menu",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"title",children:"Divergent Dreams"}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"content",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Start Game",onClick:function onClick(){gameLifecycleManager.StartGame(0);}}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Leaderboard",onClick:function onClick(){gameLifecycleManager.ToLeaderboard();}})]})]});}
...
function Hud(){var globals=useGlobals();var gameLifecycleManager=globals.gameLifecycleManager;var score=useReactiveValue(globals.score);return/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"hud",children:/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"flex-row padding-md",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(src_score,{value:score}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"spacer"}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Pause",onClick:function onClick(){gameLifecycleManager.PauseGame();}})]})});}
;// CONCATENATED MODULE: ./src/debug.tsx
function Debug(){var globals=useGlobals();var route=useReactiveValue(globals.route);var gameState=useReactiveValue(globals.debugGameState);var gameLifecycleManager=globals.gameLifecycleManager;return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"debug-ui",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"spacer"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"footer",children:/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"flex-column",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"text",children:"Debug"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"text",children:"UI Route: ".concat(route)}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"text",children:"Game State: ".concat(gameState)}),(gameState=="GameStarted"||gameState=="GamePaused")&&/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"End Game",onClick:function onClick(){gameLifecycleManager.EndGame();}})]})})]});}
;// CONCATENATED MODULE: ./src/gameOver.tsx
function GameOver(){var globals=useGlobals();var gameLifecycleManager=globals.gameLifecycleManager;var status=useReactiveValue(globals.status);var canContinue=useReactiveValue(globals.canContinue);return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"gameover",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"title",children:status}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"content",children:[!canContinue&&/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Main Menu",onClick:function onClick(){gameLifecycleManager.ReturnToMainMenu();}}),canContinue&&/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Continue",onClick:function onClick(){gameLifecycleManager.ToNextLevel();}}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"flex-row padding-md",children:/*#__PURE__*/(0,jsx_runtime.jsx)(src_score,{value:globals.score.Value})})]})]});}
;// CONCATENATED MODULE: ./src/leaderboard.tsx
function Leaderboard(){var globals=useGlobals();var gameLifecycleManager=globals.gameLifecycleManager;var leaderboardScores=useReactiveValue(globals.leaderboardScores);var LatestScore=leaderboardScores.LatestScore,LatestRanking=leaderboardScores.LatestRanking,BestScore=leaderboardScores.BestScore,BestRanking=leaderboardScores.BestRanking,GlobalBestScore=leaderboardScores.GlobalBestScore;return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"leaderboard",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"title",children:"Leaderboard"}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"content",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"score",children:["LatestScore: ",LatestScore]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"score",children:["LatestRanking: ",LatestRanking]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"score",children:["BestScore: ",BestScore]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"score",children:["BestRanking: ",BestRanking]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"score",children:["GlobalBestScore: ",GlobalBestScore]})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Main Menu",onClick:function onClick(){gameLifecycleManager.ReturnToMainMenu();}})]});}
