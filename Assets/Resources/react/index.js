...
function MainMenu(){var globals=useGlobals();var gameLifecycleManager=globals.gameLifecycleManager;return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"main-menu",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"title",children:"Rhythm Jam 2024"}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"content",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Space Pop",onClick:function onClick(){gameLifecycleManager.StartGame(0);}}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Old Man Rave",onClick:function onClick(){gameLifecycleManager.StartGame(1);}}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Leaderboard",onClick:function onClick(){gameLifecycleManager.ToLeaderboard();}})]})]});}
...
function GameOver(){var globals=useGlobals();var gameLifecycleManager=globals.gameLifecycleManager;var status=useReactiveValue(globals.status);return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"gameover",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"title",children:status}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"content",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Main Menu",onClick:function onClick(){gameLifecycleManager.ReturnToMainMenu();}}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"flex-row padding-md",children:/*#__PURE__*/(0,jsx_runtime.jsx)(src_score,{value:globals.score.Value})})]})]});}
